...
async function buildSchema() {
  ...
  await _fsExtra2.default.ensureFile(_path2.default.join(__dirname, '../data/schema.graphql.json'));
  await _fsExtra2.default.ensureFile(_path2.default.join(__dirname, '../data/schema.graphql.txt'));
